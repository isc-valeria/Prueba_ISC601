...
class Habitaciones
{
    ...
    function graficar()
    {
        $sql="select Habitaciones.id_habitacion,habitaciones.num_habitacion, (select count(Asigna_reservaciones.id_asignares)from Asigna_reservaciones where Asigna_reservaciones.id_habitacion=Habitaciones.id_habitacion) as numero  from habitaciones";
        $dato = $this->conexion->QueryResultado($sql);
        return $dato;
    }
}