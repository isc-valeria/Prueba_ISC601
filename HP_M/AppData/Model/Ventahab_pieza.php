...
class Ventahab_pieza
{
    ...
    function getAll()
    {
        $sql="SELECT ventahab_pieza.id_ventahabpieza, habitaciones.num_habitacion, clasificacion_pieza.cantidad, ticket.total, ventahab_pieza.subtotal
            FROM ventahab_pieza, habitaciones, clasificacion_pieza, ticket
            WHERE ventahab_pieza.id_habitacion = habitaciones.id_habitacion
            AND clasificacion_pieza.id_clasificacionpieza = ventahab_pieza.id_clasificacionpieza
