...
$pdf->SetX(3);
$pdf->Cell(7.31,1.5,utf8_decode('Descripción'),1,0,'C',true);
$pdf->Cell(7.31,1.5,utf8_decode('Hora de inicio'),1,0,'C',true);
$pdf->Cell(7.31,1.5,utf8_decode('Hora final'),1,0,'C',true);
...
while($row=mysqli_fetch_row($datos))
{
    ...
    $pdf->Cell(7.31,0.6,utf8_decode($row [3]),1,0,'C',true);
}
