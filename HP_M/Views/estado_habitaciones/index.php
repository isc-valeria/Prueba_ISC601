            ...
            <form action="" id="save_estadohabitacion" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="modal-fixed-footer">
                        ...
                        <div class="input-field col s12">
                            <a href="#!" id="update_estadohabitacion_ok" class="btn modal-close cyan lighten-2 black-text" data-id="">Actualizar</a>
                        </div>
                    </div>
                </div>
            </form>
...
<div class="row">
    <div class="col s8 offset-s2">
        <div class="card-panel">
            <h4 align="center">Estados de Habitaciones<span class="right"><a href="#modal_registro" class="btn cyan lighten-2 black-text modal-trigger" id="add_estadohabitacion"><i class="material-icons">add</i></a></span></h4>
            <div class="divider"></div>
            <div class="row">
