...
$pdf->SetX(3.5);
$pdf->Cell(0,5,'Registro de prendas por kilo',0,0,'L');
$pdf->ln();
...
$pdf->SetX(4);
$pdf->Cell(5,1.5,utf8_decode('Servicio'),1,0,'C',true);
$pdf->Cell(5,1.5,utf8_decode('Cantidad'),1,0,'C',true);
$pdf->Cell(5,1.5,utf8_decode('Observaciones'),1,0,'C',true);
$pdf->Cell(5,1.5,utf8_decode('Fecha de registro'),1,0,'C',true);
